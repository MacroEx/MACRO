...
uint256 hashGenesisBlock("0x00000ef864621fd13367f38431bb75ae4fbf2163a02f5fbe7d5d7f4f0db3e037");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MACRO: starting difficulty is 1 / 2^12
...
{
    // MACRO: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if (nHeight == 1)
		return 42024000 * COIN;

	// Halve every 12 months
...
{
    // MACRO: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040284710fa689ad5025690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1438715755;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2935744;
        ...
        assert(block.hashMerkleRoot == uint256("0x827ca543efebcab226818e36fae614c92446c6a24a237259d0c6a4d58b094d75"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0x93, 0xb8, 0xdf }; // MACRO: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MACROMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MACROMiner : ProcessBlock, block not accepted");
    }
